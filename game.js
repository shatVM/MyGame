...
function create() {
    ...
    bombs.children.iterate(function (child) {
        ...
        //child.setBounceY(Phaser.Math.FloatBetween(.2, 12));
        //child.setVelocityY(Phaser.Math.FloatBetween(-500, 500));
        child.setBounce(Phaser.Math.FloatBetween(0, 1));
